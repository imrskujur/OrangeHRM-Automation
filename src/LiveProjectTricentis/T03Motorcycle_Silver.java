...
public class T03Motorcycle_Silver {
	...
	public static void main(String[] args) {
		...
		model.selectByVisibleText("Scooter");
		...
		Select seats = new Select(driver.findElement(By.id("numberofseatsmotorcycle")));
		...
		driver.findElement(By.id("startdate")).sendKeys("04/04/2025");
		...
		String expPrice = "238.00", expClaim = "No", expDis = "No", expCover = "No", actPrice, actClaim, actDis, actCover;
