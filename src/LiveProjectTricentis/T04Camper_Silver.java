...
public class T04Camper_Silver {
	...
	public static void main(String[] args) {
		...
		driver.findElement(By.xpath("//*[@id=\"insurance-form\"]/div/section[1]/div[5]/p/label[2]/span")).click();
		...
		String expPrice = "263.00", expClaim = "No", expDis = "No", expCover = "No", actPrice, actClaim, actDis, actCover;
